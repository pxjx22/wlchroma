...
pub const TubeLightsRenderer = struct {
    frames: u64,
    last_advance_ms: u32,
    ...
    pub fn init(frame_advance_ms: u32, speed: f32, palette: [3]Rgb) TubeLightsRenderer {
    ...
    pub fn maybeAdvance(self: *TubeLightsRenderer, time_ms: u32) void {
