...
pub const SoftInterferenceRenderer = struct {
    frames: u64,
    last_advance_ms: u32,
    ...
    pub fn init(frame_advance_ms: u32, speed: f32, palette: [3]Rgb) SoftInterferenceRenderer {
    ...
    pub fn maybeAdvance(self: *SoftInterferenceRenderer, time_ms: u32) void {
